...
public class App {
    ...
    public static void main(String[] args) throws Exception {
       ...
       //Creation d'une règle
        List<Symptome> ListSymptomes = new ArrayList<>();
            ListSymptomes.add(new Symptome("TRISTESSE"));
            ListSymptomes.add(new Symptome("PERTE_INTERET"));
            ListSymptomes.add(new Symptome("FATIGUE_SEVERE"));
        


        Maladie maladieTest= new Maladie("depressif");

        Rules r1 = new Rules(ListSymptomes, maladieTest);


        //Creation d'un moteur
        List<Rules> reglesMoteur = new ArrayList<>();
            reglesMoteur.add(r1);
    
          List<Symptome> baseDeFait = new ArrayList<>();
            baseDeFait.add(new Symptome("TRISTESSE"));
            baseDeFait.add(new Symptome("PERTE_INTERET"));
            baseDeFait.add(new Symptome("FATIGUE_SEVERE"));
            baseDeFait.add(new Symptome("PERTE_APPETIT"));
            baseDeFait.add(new Symptome("TROUBLE_SOMMEIL"));
            baseDeFait.add(new Symptome("PENSEES_SUICIDAIRES"));
            baseDeFait.add(new Symptome("TROUBLE_PERSONNALITE"));
            baseDeFait.add(new Symptome("IMPULSIF"));
